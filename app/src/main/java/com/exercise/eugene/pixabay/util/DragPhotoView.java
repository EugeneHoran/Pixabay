...
public class DragPhotoView extends PhotoView {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float testing = (float) mAlpha / 250;
        if (testing > 1) {
            testing = 1;
        } else if (testing < 0) {
            testing = 0;
        }
        mOnMoveListener.onMove(testing);
        super.onDraw(canvas);
    }
...
//        Log.e("Testing", mAlpha + "");
    ...
    OnMoveLister mOnMoveListener;

    public void setOnMoveListener(OnMoveLister listener) {
